...
// Application is a copy of the order configuration with the addition of an anchor peers
// list in the organization defintion.
...
// AnchorPeer defines the location of peers for each application organization.
