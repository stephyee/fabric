...
func InitConfig(cmdRoot string) error {
	...
	// viper.SetDefault("peer.bccsp.default", "")
	// viper.SetDefault("peer.bccsp.pkcs11.library", "")
	// viper.SetDefault("peer.bccsp.pkcs11.pin", "")
	// viper.SetDefault("peer.bccsp.pkcs11.label", "")
	// viper.SetDefault("peer.bccsp.pkcs11.security", 256)
	// viper.SetDefault("peer.bccsp.pkcs11.hash", "")
	//
	// viper.BindEnv("PEER_BCCSP_DEFAULT")
	// viper.SetDefault("PEER_BCCSP_DEFAULT", "")
	// viper.BindEnv("PEER_BCCSP_PKCS11_LIBRARY")
	// viper.SetDefault("PEER_BCCSP_PKCS11_LIBRARY", "")
	// viper.BindEnv("PEER_BCCSP_PKCS11_PIN")
	// viper.SetDefault("PEER_BCCSP_PKCS11_PIN", "")
	// viper.BindEnv("PEER_BCCSP_PKCS11_LABEL")
	// viper.SetDefault("PEER_BCCSP_PKCS11_LABEL", "")
	// viper.BindEnv("PEER_BCCSP_PKCS11_SECURITY")
	// viper.SetDefault("PEER_BCCSP_PKCS11_SECURITY", 256)
	// viper.BindEnv("PEER_BCCSP_PKCS11_HASH")
	// viper.SetDefault("PEER_BCCSP_PKCS11_HASH", "")
